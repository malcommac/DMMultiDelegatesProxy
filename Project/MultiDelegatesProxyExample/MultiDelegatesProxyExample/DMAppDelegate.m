...
@interface DMAppDelegate() <UIScrollViewDelegate> {
...
- (UIView *)viewForZoomingInScrollView:(UIScrollView *)scrollView {
	NSLog(@"[in %@] viewForZoomingInScrollView but return value is ignored (it's not the main delegate)",NSStringFromClass(self.class));
	return nil;
}
